...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round((len(higher_edu[higher_edu['salary'] == '>50K']) / len(higher_edu)) * 100, 1)
    lower_education_rich = round((len(lower_edu[lower_edu['salary'] == '>50K']) / len(lower_edu)) * 100, 1)
    ...
    rich_percentage_country = (rich_by_country / total_by_country) * 100
